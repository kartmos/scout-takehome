...
Все обязательные этапы выполнены и приняты. Candidate готов к публикации после final commit и проверки чистого HEAD. Этап 016 остаётся optional bonus map.
