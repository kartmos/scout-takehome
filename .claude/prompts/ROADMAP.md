...
| `016` | `DONE` | Greenhouse map | Konva-canvas 40×40 m floor plan (`react-konva`/`konva`): 3 beds, real x/y markers, zoom 1×–6×, pan, 3 m near-location filter, compact/expanded drawer, bounded ≤200-photo query | Redesigned in 016.1; rewritten to Konva in 016.2 |
